...
const licenses = [
  ["mchs.png", "Лицензия МЧС", "№ 8-Б.0356 от 02.12.2013"],
  ["iso-9001.png", "Сертификат ISO 9001", "ISO 9001-2015 от 10.06.2019"],
  ["fsb.png", "Лицензия УФСБ", "№ 32527 от 30.11.2018"],
  ["sro-insurance.png", "Полис страхования гражданской ответственности", "СРО-П № 0483-507-20 от 12.08.2020"],
  ["sro-installation.png", "Выписка СРО — монтаж", "от 17.09.2020"],
  ["sro-design.png", "Выписка СРО — проектирование", "от 16.09.2020"],
];
